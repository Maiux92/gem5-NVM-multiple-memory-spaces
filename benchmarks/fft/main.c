...
static float __attribute__((section(".NVM"))) realin[1024];
static float __attribute__((section(".NVM"))) imagin[1024];
static float __attribute__((section(".NVM"))) realout[1024];
static float __attribute__((section(".NVM"))) imagout[1024];
static float __attribute__((section(".NVM"))) Coeff[16];
static float __attribute__((section(".NVM"))) Amp[16];
