...
SUPPORTED_NVM = ['SRAM', 'FRAM', 'MRAM', 'RRAM', 'STTRAM']

if len(args) != 1 or args[0] not in SUPPORTED_NVM:
    parser.error("Usage: conf-dynamic.py NVM-TYPE\nSupported types: {}\nArgs: {}".format(SUPPORTED_NVM, args))
